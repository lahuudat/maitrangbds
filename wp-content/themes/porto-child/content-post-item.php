    ...
    <div class="post-item style-5<?php echo ($porto_settings['post-title-style'] == 'without-icon') ? ' post-title-simple' : '' ?>">
        ...
        <?php if ($attachment && $attachment_related) : ?>
            ...
            <a href="<?php the_permalink(); ?>">
                ...
                <span class="post-image thumb-info<?php echo ($post_thumb_bg ? ' thumb-info-' . $post_thumb_bg : ''); echo ($post_thumb_image ? ' thumb-info-' . $post_thumb_image : ''); echo ($post_thumb_borders ? ' thumb-info-' . $post_thumb_borders : ''); ?> m-b-lg">
...
<?php } else { ?>
    ...
    <div class="post-item<?php echo ($porto_settings['post-title-style'] == 'without-icon') ? ' post-title-simple' : '' ?>">
        ...
        if ($post_author) : ?>
            ...
            <p class="author-name"><i class="fas fa-user"></i>  <?php echo __('By', 'porto'); ?> <?php the_author_posts_link(); ?> | <i class="fas fa-clock"></i>  <?php the_date(); ?></p>
