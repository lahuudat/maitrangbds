...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/style2.css?ver=<?php echo rand(111,999)?>" />
	...
	<script>
	  ...
	  fbq('init', '386555045235565');
	  fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
	  src="https://www.facebook.com/tr?id=386555045235565&ev=PageView&noscript=1"
	/></noscript>
...
$(document).ready(function(){
  $(".add-links-wrap").click(function(){
    $(".product-loop-title").trigger("click");
  });
});
</script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-131923689-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-131923689-1');
</script>
