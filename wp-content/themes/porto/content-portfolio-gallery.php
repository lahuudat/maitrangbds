...
<article <?php post_class($post_class); ?>>
    ...
    if ($slideshow_type != 'none') : ?>
        ...
        <?php if ($slideshow_type == 'images') :
            ...
            <div class="row<?php if ($porto_layout === 'widewidth') echo ' m-n' ?>">

                <ul class="portfolio-list<?php if ($porto_settings['portfolio-zoom']) : ?> lightbox<?php endif; ?>"<?php if ($porto_settings['portfolio-zoom']) : ?> data-plugin-options="<?php echo esc_attr($options) ?>"<?php endif; ?>>
                    ...
                    foreach ($featured_images as $featured_image) {
                        ...
                        if ($attachment) {
                            ...
                            <li class="col-md-3 col-sm-6 <?php if ($porto_layout === 'widewidth') echo ' p-n' ?>">

                                <div class="portfolio-item<?php if ($porto_layout === 'widewidth') echo ' m-n' ?>">

                                    <span class="thumb-info thumb-info-lighten thumb-info-centered-icons<?php if ($porto_layout === 'widewidth') echo ' thumb-info-no-borders' ?>">
