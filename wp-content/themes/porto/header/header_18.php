...
?>
<header id="header" class="header-18 <?php echo $porto_settings['search-size'] ?><?php echo ($porto_settings['logo-overlay'] && $porto_settings['logo-overlay']['url']) ? ' logo-overlay-header' : '' ?>">
